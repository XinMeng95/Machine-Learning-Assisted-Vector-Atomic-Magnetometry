...
predatapath = "E:\\20220222采数\\NNdata"
datapath = "E:\\20220222采数\\"
datasavepath = "E:\\20220222采数\\"
...
for filename in f_list:
    if 'theta' in filename:
        ...
        data = np.loadtxt(datapath + filename,dtype=float, delimiter =',')
        for i in range(1, 69):
            with open(datapath+'label.txt','a') as f:
                f.write('%5f,%5f,%5f\n' %(theta/180,phi/180,(data[i][4]-997)/9))
            with open(datasavepath+'measure.txt','a') as f:
